...
/* package baldurs-door-0.1.0.0 */
#ifndef VERSION_baldurs_door
#define VERSION_baldurs_door "0.1.0.0"
#endif /* VERSION_baldurs_door */
#ifndef MIN_VERSION_baldurs_door
#define MIN_VERSION_baldurs_door(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_baldurs_door */
...
#define CURRENT_COMPONENT_ID "baldurs-door-0.1.0.0-inplace-baldurs-door"
